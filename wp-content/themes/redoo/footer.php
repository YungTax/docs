<?php if (get_theme_mod('footer_layout_design')=='footer_layout_design_1'){?>
   <!-- Start footer -->
   <div class="bt_footer_widget_area <?php if (is_active_sidebar('footer1-sidebar') || is_active_sidebar('footer2-sidebar') || is_active_sidebar('footer3-sidebar') || is_active_sidebar('footer4-sidebar')) {echo ' bt_footer_active';}else{echo ' bt_footer_noactive';}?>">
      ...
      <a href="#" class="themelazer_go_to_top">
         <p class="themelazer_go_to_top_body">
            <span class="themelazer_go_to_text_layout_one"><?php esc_html_e('GO TO TOP', 'redoo');?></span>
      ...
      <div class="container">
         <div class="copyright-area">   
            <div class="copyright-area-inner">
                  <?php echo get_theme_mod('themelazer_copyright', esc_html__('© Copyright 2024 Themelazer. All Rights Reserved', 'redoo')); ?>
            </div>
         </div>   
      </div>   
   </footer>
...
<?php }elseif (get_theme_mod('footer_layout_design')=='footer_layout_design_2'){?> 
   ...
   <div class="bt_footer_widget_area<?php if (is_active_sidebar('footer1-sidebar') || is_active_sidebar('footer2-sidebar') || is_active_sidebar('footer3-sidebar') || is_active_sidebar('footer4-sidebar')) {echo ' bt_footer_active';}else{echo ' bt_footer_noactive';}?>">
      ...
      <a href="#" class="themelazer_go_to_top">
         <p class="themelazer_go_to_top_body">
            <span class="themelazer_go_to_text"><?php esc_html_e('GO TO TOP', 'redoo');?></span>
            <span class="themelazer_go_to_scroll_line"></span>
         </p>
      </a>
      <div class="container">
