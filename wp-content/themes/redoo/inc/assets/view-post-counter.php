...
function redoo_bac_PostViews($post_ID) {
...
function redoo_get_PostViews($post_ID){
    $count_key = 'post_views_count';
    //Returns values of the custom field with the specified key from the specified post.
...
function redoo_post_column_views($newcolumn){
    //Retrieves the translated string, if translation exists, and assign it to the 'default' array.
    $newcolumn['post_views'] = esc_html__('Views', 'redoo');
    return $newcolumn;
}
 
//Function that Populates the 'Views' Column with the number of views count.
function redoo_post_custom_column_views($column_name, $id){
...
add_filter('manage_posts_columns', 'redoo_post_column_views');
...
add_action('manage_posts_custom_column', 'redoo_post_custom_column_views',10,2);